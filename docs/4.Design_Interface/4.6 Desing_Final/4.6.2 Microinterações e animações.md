# SHOOTE <p align="end"><img src="4.6.1 Mídias/Imagens/logo.png"  style="width:10%"/> </p>
# Microinterações e Animações – Projeto Soothe

As microinterações desempenham um papel fundamental na interface do usuário ao proporcionar uma experiência mais fluida, intuitiva e agradável. No projeto **Soothe**, foram desenvolvidas animações e interações leves para melhorar a usabilidade e transmitir o propósito da aplicação, que é promover bem-estar e tranquilidade.

Nesta seção, apresento as microinterações criadas para diferentes componentes da aplicação, como a navegação, notificações e ações principais do usuário. Cada detalhe foi projetado para ser funcional, estético e alinhado à proposta de design do projeto.

## Objetivos das Microinterações:
- **Melhorar a experiência do usuário** com feedback visual e animações suaves.
- **Facilitar a navegação** pela interface, destacando ações importantes.
- **Transmitir emoções e valores do projeto**, como calma e positividade.

Siga adiante para explorar as animações implementadas, juntamente com os elementos visuais e interativos que compõem a aplicação.
